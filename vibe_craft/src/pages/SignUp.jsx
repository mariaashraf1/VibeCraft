  ...
  return (
    <div className="flex flex-col items-center justify-center mb-20 mt-5 ">
      {/* start of main container */}
        <div className="flex flex-col items-center justify-center bg-[#2C2C3C] w-[550px] h-[600px] rounded-2xl shadow-lg mx-auto mt-30">
            <img src={logo2} alt="VibeCraft Logo" className="h-15 w-auto object-contain scale-500 mt-10 " />
            <h1 className="text-3xl font-outfit-semibold mt-10 text-[#FDF8F3] text-center ">
              Sign Up</h1>
            <form className="flex flex-col items-center justify-center w-[80%] h-[95%]">
                <label className="text-[#FDF8F3] mb-2 self-start">Name</label>
                <input type="text" name="name" placeholder="Enter Your Name" className="bg-[#1E1E2E] w-full p-3 mb-6 rounded-xl shadow-md focus:shadow-lg focus:shadow-[#8FB3C0]/50 outline-none transition"/>
                ...
                <button type="submit" className="w-[50%] bg-[#7A9CAB] text-white text-xl font-outfit-semibold py-3 rounded-full  hover:bg-[#6a8f9b] hoover:border-color:[#3A3A4A] transition ">Sign Up</button>
            </form>
      </div>
    </div>
  );
