          ...
          <div className="flex flex-col ">{/* start of  main col */}
            <div className="flex items-center justify-between mt-20 ">  {/* start of row of pic and text */}
              <div className="flex flex-col ">
                <div className="flex flex-col items-start justify-center ml-20 mt-10 ">
                  {/* start of text */}
                ...
                <h3 className="text-2xl  ml-20 mt-10 ">
                  Describe Your Mood to get started
                </h3>
                <button className="bg-[#7A9CAB] text-white font-semibold py-2 rounded-full ml-20 mt-10 w-32 sm:w-40 md:w-48 hover:bg-[#6a8f9b] transition">
                  Start Now
                </button>
              </div>
